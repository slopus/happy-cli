/**
 * CodeBuddy Permission Handler
 *
 * Handles tool permission requests and responses for CodeBuddy ACP sessions.
 * Extends BasePermissionHandler with CodeBuddy-specific permission mode logic.
 */
...
/**
 * CodeBuddy-specific permission handler with permission mode support.
 */
export class CodebuddyPermissionHandler extends BasePermissionHandler {
    ...
    private shouldAutoApprove(toolName: string, toolCallId: string, input: unknown): boolean {
        ...
        // - CodebuddyReasoning: Reasoning is just display of thinking process, not an action
        // - think: Thinking/saving memories is safe
        // - save_memory: Saving memories is safe
        // - TodoRead/TodoWrite: Task list operations are safe
